...
export default function Java(props) {
    ...
    useEffect(()=>{
       axios.get("https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&maxResults=50&playlistId=PL3ToCVMGlINoHGNM1QFI7rYk579U-naic&key=AIzaSyAb_GVSDv6CNFDGXXvRWK7iwF7qqxhfQp0")
      .then(res=>{
...
{/*{item.snippet.thumbnails?.default?.url && (
                <img src={item.snippet.thumbnails.default.url} className="img-fluid rounded-start" alt="..."/>
              )} */}
